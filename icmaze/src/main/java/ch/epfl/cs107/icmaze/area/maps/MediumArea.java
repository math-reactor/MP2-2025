...
/**
 * Class, which represent the medium-sized maze areas
 */
public class MediumArea extends MazeArea {
    /**
     * Constructor for the MediumArea class, which initializes its attributes in ICMazeArea
    ...
    @Override
    /**
     * method, which returns the unique ID of this MediumArea
     * @return String - the unique ID of this LargeArea in the following format - ICMaze/MediumArea[key value]
     */
